...
export const mockStripe = {
  confirmCardPayment: async (clientSecret: string, paymentData: any): Promise<{
...
export async function processMockPayment(amount: number, giftGiverName: string): Promise<{
  success: boolean;
  paymentId?: string;
  error?: string;
}> {
